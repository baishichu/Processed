...
lora_path = "/media/ph/208B-304E/llamaF/LLaMA-Factory/saves/qwen3-4b/PPRlora/sft"
...
save_name = 'sammq346.jsonl'
# save_name = 'casmeq346.jsonl'
print(save_name)
data = []
            ...
            "content": [
                {"type": "image"},
                {
                    ...
                    "text": (
                        ...
                        "Please answer using only one label from:\n"
