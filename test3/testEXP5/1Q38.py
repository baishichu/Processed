...
base_model = Qwen3VLForConditionalGeneration.from_pretrained(
    "/media/ph/29321BB58B527E5A/qwen/qwen3vl8/Qwen3-VL-8B-Instruct",
    dtype=torch.bfloat16,
    device_map="auto",
)
lora_path = "/media/ph/208B-304E/llamaF/LLaMA-Factory/saves/qwen3-8b/PPRlora1/sft"
...
save_name = 'sammq385.jsonl'
# save_name = 'casmeq385.jsonl'
print(save_name)
data = []
