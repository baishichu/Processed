...
lora_path = "/media/ph/208B-304E/llamaFactory/LLaMA-Factory/examples/train_lora/saves/ROandP/qwen2_5vl-4b/lora/sft/checkpoint-450"
...
save_name = jsonl_name + 'q253.jsonl'
print(save_name)
data = []
