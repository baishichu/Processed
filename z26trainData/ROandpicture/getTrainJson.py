...
datadir = "/media/ph/208B-304E/projectVQA/MEGC2025VQA/Processed/trainData"
# input_file = 'z26TrainJsonl/casme2.jsonl'
# output_file = "z26trainData/ROandpicture/casmetrain.jsonl"
...
# output_file = "z26trainData/ROandpicture/sammtrain.jsonl"
# os.makedirs(os.path.dirname(output_file), exist_ok=True)
# with open(input_file, "r", encoding="utf-8") as infile, open(output_file, "w", encoding="utf-8") as outfile:
#     for line in infile:
#         data = json.loads(line.strip())
...
output_file = "z26trainData/ROandpicture/smictrain.jsonl"
os.makedirs(os.path.dirname(output_file), exist_ok=True)
with open(input_file, "r", encoding="utf-8") as infile, open(output_file, "w", encoding="utf-8") as outfile:
    for line in infile:
        data = json.loads(line.strip())
