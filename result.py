...
lora_path = "/media/ph/208B-304E/llamaFactory/LLaMA-Factory/saves/qwen2_5vl-7b/lora/sft/checkpoint-944"
...
picdir = "/media/ph/208B-304E/projectVQA/MEGC2025VQA/Processed/TV"
...
with open(os.path.join(dir), 'r') as f:
    for line in f:
        ...
        image_path = os.path.join(picdir, video_name + ".jpg")
